...
new_faqs_passivhaus = [
    {"q": "¿Es más caro construir una Casa Pasiva que una normal?", "a": "La inversión inicial en una casa pasiva suele ser entre un 10% y un 15% superior debido al extra de aislamiento, las ventanas de alta gama y el sistema de ventilación. Sin embargo, este sobrecoste se amortiza en los primeros 7-10 años gracias a la drástica reducción de las facturas de luz y gas."},
    {"q": "¿Se pueden abrir las ventanas en una casa Passivhaus?", "a": "¡Por supuesto! Es un falso mito creer que son casas herméticas donde no se puede abrir la ventana. Puedes abrirlas cuando quieras, aunque gracias al sistema de ventilación mecánica, el aire interior siempre estará fresco, filtrado y a la temperatura ideal, por lo que no sentirás la necesidad de ventilar abriendo ventanas."},
    {"q": "¿Cualquier diseño arquitectónico puede ser una casa pasiva?", "a": "Casi cualquier diseño puede adaptarse, pero es mucho más económico y eficiente si la arquitectura se piensa con criterios pasivos desde el primer boceto (formas compactas, ventanas grandes al sur y pequeñas al norte, protección solar). Modificar un diseño ya terminado para que cumpla el estándar pasivo suele ser más complejo."}
]

new_faqs_unifamiliares = [
    {"q": "¿Gestionáis también la construcción de la piscina y los muros de la parcela?", "a": "Sí, realizamos el proyecto completo. Incluimos en la ejecución material el movimiento de tierras, cimentación, construcción del vaso de la piscina, instalaciones de depuración, vallado perimetral de la parcela, puertas motorizadas y paisajismo básico."},
    {"q": "¿Qué sistema de climatización es mejor para un chalet en Valencia?", "a": "La combinación ganadora actual en la Comunitat Valenciana es la Aerotermia combinada con suelo radiante-refrescante (apoyado por fancoils por conductos para los picos de calor en agosto) y un sistema de paneles solares fotovoltaicos para reducir el consumo eléctrico a casi cero."},
    {"q": "¿Puedo aportar yo los materiales de acabado (suelos, grifos) y vosotros solo la mano de obra?", "a": "Por norma general recomendamos que la constructora adquiera y suministre los materiales de acabado para poder ofrecer una garantía integral sobre el producto y la instalación. Si suministras tú el material, nuestra garantía solo puede cubrir la mano de obra, y cualquier retraso en tu suministro afectará al plazo de la obra."}
]

new_faqs_lujo = [
    {"q": "¿Trabajáis con marcas internacionales específicas?", "a": "Sí, instalamos firmas de primera línea a petición de nuestros clientes y sus interioristas, tales como cocinas Boffi, Bulthaup o Gaggenau, iluminación Flos o Vibia, sanitarios Antonio Lupi, domótica Jung o Gira, entre otras."},
    {"q": "¿Ofrecéis servicio de mantenimiento post-obra?", "a": "Para nuestros proyectos de Alta Calidad y Lujo ofrecemos contratos de mantenimiento integral preventivo tras la entrega de la vivienda. Esto incluye la revisión semestral de climatización, limpieza de placas solares, revisión de domótica, piscinas y puesta a punto general."},
    {"q": "¿Podéis ejecutar obras mientras nosotros vivimos en la vivienda?", "a": "En rehabilitaciones de lujo de grandes villas o áticos, siempre recomendamos la mudanza temporal por seguridad y para no afectar los tiempos de ejecución. Sin embargo, en grandes fincas donde sea posible sectorizar y aislar completamente el área de obra del área de vida, podemos estudiar la logística para hacerlo viable."}
]
...
services_updates = {
    'construccion-casas-pasivas-valencia': {
        'content': c_passivhaus,
        'new_faqs': new_faqs_passivhaus
    },
    'construccion-viviendas-unifamiliares-valencia': {
        'content': c_unifamiliares,
        'new_faqs': new_faqs_unifamiliares
    },
    'construccion-lujo-alta-calidad-valencia': {
        'content': c_lujo,
        'new_faqs': new_faqs_lujo
    }
}
...
print("Updated constants.ts for passivhaus, unifamiliares, and lujo.")
