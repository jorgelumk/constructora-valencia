...
new_faqs_piscinas = [
    {"q": "¿Cuánto se tarda en construir una piscina de obra?", "a": "El proceso habitual, desde que entra la excavadora hasta que puedes darte el primer baño, suele durar entre 3 y 5 semanas, dependiendo de si surgen complicaciones en la excavación (aparición de roca o agua freática) y del tamaño de la piscina."},
    {"q": "¿Necesito licencia del Ayuntamiento para hacer una piscina en mi chalet?", "a": "Sí, la construcción de una piscina requiere presentar un Proyecto Técnico redactado por un arquitecto o ingeniero y solicitar la correspondiente Licencia de Obras en el Ayuntamiento de tu localidad. Nosotros nos encargamos de todo el trámite legal."},
    {"q": "¿Qué profundidad es la ideal para una piscina privada?", "a": "Actualmente, la tendencia es hacer piscinas más bien planas (fondo continuo de 1,20 a 1,40 metros). Esto permite hacer pie en toda la piscina, facilitando el juego, reduciendo drásticamente el consumo de agua, los productos químicos y el coste de calentarla."}
]

new_faqs_promotora = [
    {"q": "¿Qué significa comprar sobre plano?", "a": "Significa reservar la vivienda antes de que esté construida, basándose en los planos, infografías y memoria de calidades del proyecto. La ventaja es conseguir un precio inferior y poder elegir la vivienda con mejor orientación de la promoción, además de permitir la personalización de acabados."},
    {"q": "¿Cómo pago una vivienda de vuestra promoción?", "a": "Normalmente se hace una reserva inicial (señal). Al firmar el contrato de compraventa se abona un 10%, durante la construcción se abona otro 10% dividido en mensualidades, y el 80% restante se paga a la firma de las escrituras ante notario (momento en el que puedes subrogarte a nuestra hipoteca promotor o pedir una propia)."},
    {"q": "¿Están seguros mis ahorros si compro antes de que terminéis la obra?", "a": "Totalmente seguros. Por ley, todas las aportaciones económicas que haces durante la construcción se depositan en una cuenta bancaria especial y están blindadas por un aval bancario. Si por fuerza mayor la promoción no se entregara, el banco te devolvería el 100% de tu dinero más los intereses legales."}
]

new_faqs_banos_cocinas = [
    {"q": "¿Tengo que comprar yo los azulejos y sanitarios?", "a": "Puedes hacerlo si quieres, pero nuestro servicio es 'llave en mano'. Te acompañamos a nuestras exposiciones asociadas, eliges lo que te guste y nosotros nos encargamos de la compra, el transporte hasta la obra y asumir la responsabilidad si llega algo roto o hay que hacer devoluciones."},
    {"q": "¿Hacéis reformas sin obra (aplicar pintura, microcemento, etc.)?", "a": "Sí, si las instalaciones de fontanería y electricidad están en buen estado, podemos aplicar revestimientos continuos como el microcemento sobre los azulejos antiguos y cambiar el mobiliario, consiguiendo un aspecto totalmente nuevo sin necesidad de desescombro."},
    {"q": "¿Puedo cambiar la cocina de sitio y llevarla al salón?", "a": "En la mayoría de los casos, sí. El principal condicionante para mover una cocina o un baño es la pendiente necesaria para el desagüe del fregadero o el inodoro hasta la bajante general del edificio. Nuestro fontanero técnico evaluará tu piso para confirmar la viabilidad antes de darte el presupuesto."}
]
...
services_updates = {
    'construccion-piscinas-valencia': {
        'content': c_piscinas,
        'new_faqs': new_faqs_piscinas
    },
    'promotora-valencia': {
        'content': c_promotora,
        'new_faqs': new_faqs_promotora
    },
    'reformas-banos-cocinas-valencia': {
        'content': c_banos_cocinas,
        'new_faqs': new_faqs_banos_cocinas
    }
}
...
print("Updated constants.ts for piscinas, promotora, and banos_cocinas.")
