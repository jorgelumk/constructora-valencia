...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE.url}/quienes-somos/`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.7 },
    { url: `${SITE.url}/constructora-paterna/`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE.url}/constructora-torrent/`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE.url}/constructora-leliana/`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE.url}/constructora-rocafort/`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
